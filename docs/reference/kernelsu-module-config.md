# KernelSU Module Configuration — Complete Reference

> **Source:** https://kernelsu.org/guide/module-config.html
> **Raw source:** https://github.com/tiann/KernelSU/blob/main/website/docs/guide/module-config.md
> **Fetched:** 2026-02-01
> **Related:** [Module Guide](https://kernelsu.org/guide/module.html) (appended below as supplementary reference)
...
# APPENDIX: KernelSU Module Guide (Complete Reference)

> **Source:** https://kernelsu.org/guide/module.html
> **Raw source:** https://github.com/tiann/KernelSU/blob/main/website/docs/guide/module.md

This appendix contains the full KernelSU Module Guide for complete context on module structure, installation, boot scripts, and lifecycle.
...
The module mechanism of KernelSU is almost the same as that of Magisk. If you're familiar with Magisk module development, developing KernelSU modules is very similar. You can skip the introduction of modules below and just read [Difference with Magisk](https://kernelsu.org/guide/difference-with-magisk.html).
...
KernelSU's modules support displaying interfaces and interacting with users. For more details, refer to the [WebUI documentation](https://kernelsu.org/guide/module-webui.html).

## Module Configuration

KernelSU provides a built-in configuration system that allows modules to store persistent or temporary key-value settings. For more details, refer to the [Module Configuration documentation](https://kernelsu.org/guide/module-config.html).
...
> The `system` directory is only mounted if you have a metamodule installed that provides mounting functionality (such as `meta-overlayfs`). The metamodule handles how modules are mounted. See the [Metamodule Guide](https://kernelsu.org/guide/metamodule.html) for more information.
...
If you're interested in OverlayFS, it's recommended to read the Linux Kernel's [documentation on OverlayFS](https://docs.kernel.org/filesystems/overlayfs.html). For details on KernelSU's metamodule system, see the [Metamodule Guide](https://kernelsu.org/guide/metamodule.html).

...
export const accentPresets: Record<string, { gradient: string; textAccent: string; rgb: string; textOnAccent: string }> = {
  ...
  '#FF9F0A': {
    gradient: 'linear-gradient(135deg, #FFB74D 0%, #FF9F0A 50%, #E67E00 100%)',
    textAccent: '#FF9F0A',
    rgb: '255, 159, 10',
    textOnAccent: '#000000',
  },
  '#30D158': {
    gradient: 'linear-gradient(135deg, #69F0AE 0%, #30D158 50%, #00A832 100%)',
    textAccent: '#30D158',
    rgb: '48, 209, 88',
    textOnAccent: '#000000',
  },
  '#0A84FF': {
    gradient: 'linear-gradient(135deg, #5AC8FA 0%, #0A84FF 50%, #0055CC 100%)',
    textAccent: '#0A84FF',
    rgb: '10, 132, 255',
    textOnAccent: '#FFFFFF',
  },
  '#BF5AF2': {
    gradient: 'linear-gradient(135deg, #D895FA 0%, #BF5AF2 50%, #8944AB 100%)',
    textAccent: '#BF5AF2',
    rgb: '191, 90, 242',
    textOnAccent: '#FFFFFF',
  },
  '#FF6348': {
    gradient: 'linear-gradient(135deg, #FFA79A 0%, #FF6348 50%, #D94B30 100%)',
    textAccent: '#FF6348',
    rgb: '255, 99, 72',
    textOnAccent: '#FFFFFF',
  },
  '#00D2D3': {
    gradient: 'linear-gradient(135deg, #67F2F2 0%, #00D2D3 50%, #00A3A4 100%)',
    textAccent: '#00D2D3',
    rgb: '0, 210, 211',
    textOnAccent: '#000000',
  },
...
export function applyTheme(themeObj: Theme, accentColor?: string) {
  const root = document.documentElement;
  root.style.setProperty('--bg-primary', themeObj.bgPrimary);
  const isLight = themeObj.name === 'light';
  const isAmoled = themeObj.name === 'amoled';

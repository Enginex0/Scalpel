      ...
      <div>
        ...
        <Card variant="glass" padding="medium">
          <div style="display:flex;flex-direction:column;gap:16px;">
            ...
            <div style="display:flex;align-items:center;justify-content:space-between;">
              <div>
                <div style="font-size:13px;font-weight:500;">Deferred Uninstall</div>
                <div style="font-size:11px;color:var(--text-tertiary);">Remove /data/app copy after systemize verification</div>
              </div>
              <Toggle checked={store.settings.deferredUninstall} onChange={(v) => store.updateSettings({ deferredUninstall: v })} />
            </div>
